...
```php
$pipeline2[] = ['$group' => ['_id' => '$usuari','count' => ['$sum' => 1]]];
...
Agrupa els documents pel camp d'usuari i compta quants d'usuaris existeixen per cada URL.

```php
['$group' => ['_id' => '$usuari','count' => ['$sum' => 1]]];
```
